...
class LightRAG:
    ...
    kv_storage: str = field(default=get_env_value("LIGHTRAG_KV_STORAGE", "PGKVStorage"))
    """Storage backend for key-value data."""

    vector_storage: str = field(default=get_env_value("LIGHTRAG_VECTOR_STORAGE", "PGVectorStorage"))
    """Storage backend for vector embeddings."""

    graph_storage: str = field(default=get_env_value("LIGHTRAG_GRAPH_STORAGE", "FalkorDBStorage"))
