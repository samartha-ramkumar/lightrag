...
DEFAULT_CONFIG = {
    ...
    "test_cases": {
        "basic": {"query": "How many disciples does Tang Monk have?"},
        "generate": {"query": "Who is the director of the TV series Journey to the West?"},
    },
}
...
EXAMPLE_CONVERSATION = [
    ...
    {"role": "assistant", "content": "Hello! I am an AI assistant and I am happy to serve you."},
...
def test_generate_concurrent() -> None:
    ...
    async def run_concurrent_requests():
        prompts = ["First question", "Second question", "Third question", "Fourth question", "Fifth question"]
